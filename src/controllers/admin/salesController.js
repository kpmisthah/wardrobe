...
const loadsalesReport = async(req,res)=>{
    try {
        ...
        res.render('admin/salesReport', { totalOrders, totalUsers, totalProducts, totalSales,totalDiscount, orders });
    } catch (error) {
...
export{salesReport,loadsalesReport,generatePdfReport,generateExcelReport}